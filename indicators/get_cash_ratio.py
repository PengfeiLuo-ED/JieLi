# -*- coding: utf-8 -*-
"""
Created on Mon Apr 29 16:24:05 2019
...
class BaseComputation(object):
      ...
      def compute_factor_in_peer(self, **kwargs):
          pass
      # endregion
class ComputeCashRatio(BaseComputation):
      computation_model_name = '现金比率'
      ...
      def compute_factor(self,stock_code, end_date):
          ...
          result3 = con.ExeQuery('SELECT * from HK_STK_FIN_CashFlow')
          ...
          result1 = result1[['ReportType','Symbol','CurrentLiabilities','YearEnd']]
          result2 = result2[['ReportType','Symbol','Deposits','YearEnd']]
          result2.columns = ['ReportType','Symbol','CurrentLiabilities','YearEnd']
          result3 = result3[['ReportType','Symbol','NCFEY','YearEnd']] 
          result3.loc[result3.ReportType == 2,['NCFEY']] = result3.loc[result3.ReportType == 2,['NCFEY']] * 2
          result1 = pd.concat([result1,result2],axis = 0)          
          result1 = result1[result1['Symbol'] == stock_code][['ReportType','CurrentLiabilities','YearEnd']]
          result1 = result1.sort_values(by = 'YearEnd')
          result3 = result3[result3['Symbol'] == stock_code][['ReportType','NCFEY','YearEnd']]
...
if __name__ == '__main__':
   compute_cash_ratio = ComputeCashRatio()
   rst = compute_cash_ratio.compute_factor('E00005', '20190423')
   print(rst)    
   
   data_peer = compute_cash_ratio.compute_factor_in_peer('E00005', '20190423')
   print(data_peer)
