# -*- coding: utf-8 -*-
"""
Created on Mon Apr 29 15:27:07 2019
...
class BaseComputation(object):
      ...
      def compute_factor_in_peer(self, **kwargs):
          pass
      # endregion
class ComputeDebtAssetRatio(BaseComputation):
      computation_model_name = '资产负债率'
      ...
      def compute_factor(self,stock_code, end_date):
          ...
          result1 = result1[['ReportType','Symbol','DebtAssetRatio','YearEnd']]
          result2 = result2[['ReportType','Symbol','TotalAssets','TotalLiabilities','YearEnd']]
          result2['DebtAssetRatio'] = result2['TotalLiabilities'] * 100 / result2['TotalAssets']
          result2 = result2.loc[:,['ReportType','Symbol','DebtAssetRatio','YearEnd']] 
          result1 = pd.concat([result1,result2],axis = 0)
          result1 = result1[result1['Symbol'] == stock_code][['ReportType','DebtAssetRatio','YearEnd']]
...
if __name__ == '__main__':
   compute_debt_asset_ratio = ComputeDebtAssetRatio()
   rst = compute_debt_asset_ratio.compute_factor('E02319', '20190423')
   print(rst)    
   
   data_peer = compute_debt_asset_ratio.compute_factor_in_peer('E02319', '20190423')
   print(data_peer)
