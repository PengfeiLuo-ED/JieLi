# -*- coding: utf-8 -*-
"""
Created on Mon Apr 29 16:54:54 2019
...
class BaseComputation(object):
      ...
      def compute_factor_in_peer(self, **kwargs):
          pass
      # endregion
class ComputeBookLeverageRatio(BaseComputation):
      computation_model_name = '账面杠杆比率'
      ...
      def compute_factor(self,stock_code, end_date):
          ...
          result1 = result1[['ReportType','Symbol','TotalLiabilities','Equity','YearEnd']]
          result2 = result2[['ReportType','Symbol','TotalLiabilities','Equity','YearEnd']]         
          result1 = pd.concat([result1,result2],axis = 0)          
          result1 = result1[result1['Symbol'] == stock_code][['ReportType','TotalLiabilities','Equity','YearEnd']]          
...
if __name__ == '__main__':
   compute_book_leverage_ratio = ComputeBookLeverageRatio()
