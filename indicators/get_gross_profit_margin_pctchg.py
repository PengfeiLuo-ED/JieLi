# -*- coding: utf-8 -*-
"""
Created on Fri May 10 13:40:07 2019
...
class BaseComputation(object):
      ...
      def compute_factor_in_peer(self, **kwargs):
          pass
      # endregion
class ComputeGrossProfitMargin(BaseComputation):
      computation_model_name = '毛利率增长率'
      ...
      def compute_factor(self,stock_code, end_date):
          ...
          result1 = result1[['ReportType','Symbol','Pre_taxProfitMargin','YearEnd']]
          result1 = result1[result1['Symbol'] == stock_code][['ReportType','Pre_taxProfitMargin','YearEnd']]
          ...
          try:
              ...
              history_quantile = 1
          return [history_number, history_quantile, re6, re12]
...
if __name__ == '__main__':
   compute_gross_profit_margin = ComputeGrossProfitMargin()
   rst = compute_gross_profit_margin.compute_factor('E03335', '20190423')
   print(rst)    
   
   data_peer = compute_gross_profit_margin.compute_factor_in_peer('E03335', '20190423')
   print(data_peer)
