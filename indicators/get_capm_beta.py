...
if __name__ == '__main__':
   model = ComputationCapmBeta()
   rst = model.compute_factor('E02319', 'EHSI', '20190418', 250)
   print(rst)
   #data_peer = model.compute_factor_in_peer('E00700', 'EHSI', '20190403', 250)
   #print(data_peer)
