...
class BaseComputation(object):
      ...
      def compute_factor_in_peer(self, **kwargs):
          pass
      # endregion
class ComputeNetProfitPctchg(BaseComputation):
      computation_model_name = '净利润同比增长率'
      ...
      def compute_factor(self,stock_code, end_date):
          ...
          result1 = result1[['ReportType','Symbol','Currency','NetProfit','YearEnd']]
          result2 = result2[['ReportType','Symbol','Currency','NetProfit','YearEnd']]
          result1 = pd.concat([result1,result2],axis = 0)
          result1 = result1[result1['Symbol'] == stock_code][['ReportType','Currency','NetProfit','YearEnd']]
          result1.loc[result1.ReportType == 2,'NetProfit'] = result1.loc[result1.ReportType == 2,'NetProfit'] * 2
          result1.loc[result1.Currency == 'CNY','NetProfit'] = result1.loc[result1.Currency == 'CNY','NetProfit'] / 0.85        
          result1.loc[result1.Currency == 'JPY','NetProfit'] = result1.loc[result1.Currency == 'JPY','NetProfit'] / 5.99
          result1.loc[result1.Currency == 'MYR','NetProfit'] = result1.loc[result1.Currency == 'MYR','NetProfit'] * 1.62
          result1.loc[result1.Currency == 'SGD','NetProfit'] = result1.loc[result1.Currency == 'SGD','NetProfit'] * 4.95
          result1.loc[result1.Currency == 'USD','NetProfit'] = result1.loc[result1.Currency == 'USD','NetProfit'] * 7.6
...
if __name__ == '__main__':
   compute_net_profit_pctchg = ComputeNetProfitPctchg()
   rst = compute_net_profit_pctchg.compute_factor('E02318', '20190423')
   print(rst)    
   data_peer = compute_net_profit_pctchg.compute_factor_in_peer('E02318', '20190403')
   print(data_peer)
