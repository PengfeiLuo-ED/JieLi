# -*- coding: utf-8 -*-
"""
Created on Mon Apr 29 15:47:28 2019
...
class BaseComputation(object):
      ...
      def compute_factor_in_peer(self, **kwargs):
          pass
      # endregion
class ComputeCurrentRatio(BaseComputation):
      computation_model_name = '流动比率'
      ...
      def compute_factor(self,stock_code, end_date):
          ...
          result1 = result1[['ReportType','Symbol','CurrentRatio','YearEnd']]
          result2 = result2[['ReportType','Symbol','CoreAdequacyRatio','YearEnd']]
          result2['CoreAdequacyRatio'] = result2['CoreAdequacyRatio'] / 10
          result2.columns = ['ReportType','Symbol','CurrentRatio','YearEnd']           
          result1 = pd.concat([result1,result2],axis = 0)
          result1 = result1[result1['Symbol'] == stock_code][['ReportType','CurrentRatio','YearEnd']]
...
if __name__ == '__main__':
   compute_current_ratio = ComputeCurrentRatio()
   rst = compute_current_ratio.compute_factor('E02318', '20190423')
   print(rst)    
   
   data_peer = compute_current_ratio.compute_factor_in_peer('E02318', '20190423')
   print(data_peer)
