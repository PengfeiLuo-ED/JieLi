# -*- coding: utf-8 -*-
"""
Created on Tue Apr 30 15:41:08 2019
...
class BaseComputation(object):
      ...
      def compute_factor_in_peer(self, **kwargs):
          pass
      # endregion
class ComputeNonCurrentAssetRatio(BaseComputation):
      computation_model_name = '固定资产占比'
      ...
      def compute_factor(self,stock_code, end_date):
          ...
          result1 = result1[['ReportType','Symbol','Non_currentAssets','TotalAssets','YearEnd']]
          result2 = result2[['ReportType','Symbol','Loans','TotalAssets','YearEnd']]  
          result2.columns = ['ReportType','Symbol','Non_currentAssets','TotalAssets','YearEnd']
          result1 = pd.concat([result1,result2],axis = 0)          
          result1 = result1[result1['Symbol'] == stock_code][['ReportType','Non_currentAssets','TotalAssets','YearEnd']]
...
if __name__ == '__main__':
   compute_non_current_asset_ratio = ComputeNonCurrentAssetRatio()
   rst = compute_non_current_asset_ratio.compute_factor('E00005', '20190423')
   print(rst)    
   
   data_peer = compute_non_current_asset_ratio.compute_factor_in_peer('E00005', '20190423')
   print(data_peer)
