# -*- coding: utf-8 -*-
"""
Created on Mon Apr 29 13:59:45 2019
...
class BaseComputation(object):
      ...
      def compute_factor_in_peer(self, **kwargs):
          pass
      # endregion
class ComputeOperatingProfitMargin(BaseComputation):
      computation_model_name = '主营业务利润率'
      ...
      def compute_factor(self,stock_code, end_date):
          ...
          result1 = result1[['ReportType','Symbol','OperatingProfitMargin','YearEnd']]
          result2 = result2[['ReportType','Symbol','Loans_TotalAssets','YearEnd']]
          result2.columns = ['ReportType','Symbol','OperatingProfitMargin','YearEnd'] 
          result1 = pd.concat([result1,result2],axis = 0)
          result1 = result1[result1['Symbol'] == stock_code][['ReportType','OperatingProfitMargin','YearEnd']]
...
if __name__ == '__main__':
   compute_operating_profit_margin = ComputeOperatingProfitMargin()
   rst = compute_operating_profit_margin.compute_factor('E00005', '20190423')
   print(rst)    
   
   data_peer = compute_operating_profit_margin.compute_factor_in_peer('E00005', '20190423')
   print(data_peer)
