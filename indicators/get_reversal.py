...
class BaseComputation(object):
      ...
      def compute_factor_in_peer(self, **kwargs):
          pass
      # endregion
class ComptePriceReversal(BaseComputation):
    computation_model_name = '价格反转'
...
if __name__ == '__main__':
    compute_ret_vol = ComptePriceReversal()
    rst = compute_ret_vol.compute_factor('E00700','20190403',14)
    print(rst)
    
    #data_peer = compute_ret_vol.compute_factor_in_peer('E00700','20190403',14)
