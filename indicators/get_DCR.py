...
class BaseComputation(object):
      ...
      def compute_factor_in_peer(self, **kwargs):
          pass
      # endregion
class ComputeDCR(BaseComputation):
      computation_model_name = '债务保障比率'
      ...
      def compute_factor(self,stock_code, end_date):
          ...
          result1 = result1[result1['Symbol'] == stock_code][['ReportType','Currency','TotalLiabilities','ModifyTime']]
          result1.loc[result1.ReportType == 2,'TotalLiabilities'] = result1.loc[result1.ReportType == 2,'TotalLiabilities'] *2
          result1.loc[result1.Currency == 'CNY','TotalLiabilities'] = result1.loc[result1.Currency == 'CNY','TotalLiabilities'] / 0.85        
          result1.loc[result1.Currency == 'JPY','TotalLiabilities'] = result1.loc[result1.Currency == 'JPY','TotalLiabilities'] / 5.99
          result1.loc[result1.Currency == 'MYR','TotalLiabilities'] = result1.loc[result1.Currency == 'MYR','TotalLiabilities'] * 1.62
          result1.loc[result1.Currency == 'SGD','TotalLiabilities'] = result1.loc[result1.Currency == 'SGD','TotalLiabilities'] * 4.95
          result1.loc[result1.Currency == 'USD','TotalLiabilities'] = result1.loc[result1.Currency == 'USD','TotalLiabilities'] * 7.6
          ...
          result = result.sort_values(by = 'ModifyTime')  
...
if __name__ == '__main__':
   compute_dcr = ComputeDCR()
   rst = compute_dcr.compute_factor('E00941', '20190423')
   print(rst)
   #data_peer = compute_dcr.compute_factor_in_peer('E00700', '20190418')
   #print(data_peer)
