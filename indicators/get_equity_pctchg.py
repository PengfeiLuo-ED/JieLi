...
class BaseComputation(object):
      ...
      def compute_factor_in_peer(self, **kwargs):
          pass
      # endregion
class ComputeEQUITYPctchg(BaseComputation):
      computation_model_name = '资本累积同比增长率'
      ...
      def compute_factor(self,stock_code, end_date):
          ...
          result1 = result1[['ReportType','Symbol','Currency','Equity','YearEnd']]
          result2 = result2[['ReportType','Symbol','Currency','Equity','YearEnd']]
          result1 = pd.concat([result1,result2],axis = 0)
          del result2
          result1 = result1[result1['Symbol'] == stock_code][['ReportType','Currency','Equity','YearEnd']]
...
if __name__ == '__main__':
   compute_equity_pctchg = ComputeEQUITYPctchg()
   rst = compute_equity_pctchg.compute_factor('E02318', '20190403')
   print(rst)
    
   data_peer = compute_equity_pctchg.compute_factor_in_peer('E02318', '20190403')
   print(data_peer)
