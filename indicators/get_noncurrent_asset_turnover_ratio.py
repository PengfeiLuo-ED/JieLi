# -*- coding: utf-8 -*-
"""
Created on Tue Apr 30 15:17:41 2019
...
class BaseComputation(object):
      ...
      def compute_factor_in_peer(self, **kwargs):
          pass
      # endregion
class ComputeNonCurrentAssetTurnoverRatio(BaseComputation):
      computation_model_name = '固定资产周转率'
      ...
      def compute_factor(self,stock_code, end_date):
          ...
          result1 = result1[['ReportType','Symbol','Non_currentAssets','YearEnd']]
          result2 = result2[['ReportType','Symbol','Loans','YearEnd']]  
          result2.columns = ['ReportType','Symbol','Non_currentAssets','YearEnd']
          result1 = pd.concat([result1,result2],axis = 0)          
          result1 = result1[result1['Symbol'] == stock_code][['ReportType','Non_currentAssets','YearEnd']]
...
if __name__ == '__main__':
   compute_non_current_asset_turnover_ratio = ComputeNonCurrentAssetTurnoverRatio()
   rst = compute_non_current_asset_turnover_ratio.compute_factor('E00005', '20190423')
   print(rst)    
   
   data_peer = compute_non_current_asset_turnover_ratio.compute_factor_in_peer('E00005', '20190423')
   print(data_peer)
