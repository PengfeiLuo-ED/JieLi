# -*- coding: utf-8 -*-
"""
Created on Tue Apr 30 14:31:36 2019
...
class BaseComputation(object):
      ...
      def compute_factor_in_peer(self, **kwargs):
          pass
      # endregion
class ComputeInventoryTurnoverRatio(BaseComputation):
      computation_model_name = '存货周转率'
      ...
      def compute_factor(self,stock_code, end_date):
          ...
          result1 = result1[['ReportType','Symbol','InventoryTurnover','YearEnd']]
          result1 = result1[result1['Symbol'] == stock_code][['ReportType','InventoryTurnover','YearEnd']]
          result1 = result1.sort_values(by = 'YearEnd')
          result1.loc[result1.ReportType=='2','InventoryTurnover'] = result1.loc[result1.ReportType=='2','InventoryTurnover'] * 2  
...
if __name__ == '__main__':
   compute_inventory_turnover_ratio = ComputeInventoryTurnoverRatio()
   rst = compute_inventory_turnover_ratio.compute_factor('E00700', '20190423')
   print(rst)    
   
   data_peer = compute_inventory_turnover_ratio.compute_factor_in_peer('E00005', '20190423')
   print(data_peer)
