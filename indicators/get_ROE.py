# -*- coding: utf-8 -*-
"""
Created on Mon Apr 29 10:17:50 2019
...
class BaseComputation(object):
      ...
      def compute_factor_in_peer(self, **kwargs):
          pass
      # endregion
class ComputeROE(BaseComputation):
      computation_model_name = 'ROE'
      ...
      def compute_factor(self, stock_code, end_date):
          ...
          result1 = result1[['ReportType','Symbol','ReturnOnEquity','YearEnd']]
          result2 = result2[['ReportType','Symbol','ReturnOnEquity','YearEnd']]      
          result1 = pd.concat([result1,result2],axis = 0)
          del result2
          result1 = result1[result1['Symbol'] == stock_code][['ReportType','ReturnOnEquity','YearEnd']]
          result1 = result1.sort_values(by = 'YearEnd')
          result1.loc[result1.ReportType=='2','ReturnOnEquity'] = result1.loc[result1.ReportType=='2','ReturnOnEquity'] * 2           
...
if __name__ == '__main__':
   compute_roe = ComputeROE()
   rst = compute_roe.compute_factor('E02318', '20190403')
   print(rst)
    
   data_peer = compute_roe.compute_factor_in_peer('E02318', '20190403')
   print(data_peer)
