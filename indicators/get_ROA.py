# -*- coding: utf-8 -*-
"""
Created on Mon Apr 29 09:56:20 2019
...
class BaseComputation(object):
      ...
      def compute_factor_in_peer(self, **kwargs):
          pass
      # endregion
class ComputeROA(BaseComputation):
      computation_model_name = 'ROA'
      ...
      def compute_factor(self,stock_code, end_date):
          ...
          result1 = result1[['ReportType','Symbol','ReturnOnTotalAssets','YearEnd']]
          result2 = result2[['ReportType','Symbol','ReturnOnTotalAssets','YearEnd']]      
          result1 = pd.concat([result1,result2],axis = 0)
          del result2
          result1 = result1[result1['Symbol'] == stock_code][['ReportType','ReturnOnTotalAssets','YearEnd']]
          result1 = result1.sort_values(by = 'YearEnd')
          result1.loc[result1.ReportType=='2','ReturnOnTotalAssets'] = result1.loc[result1.ReportType=='2','ReturnOnTotalAssets'] * 2           
...
if __name__ == '__main__':
   compute_roa = ComputeROA()
   rst = compute_roa.compute_factor('E02318', '20190403')
   print(rst)
    
   data_peer = compute_roa.compute_factor_in_peer('E02318', '20190403')
   print(data_peer)
