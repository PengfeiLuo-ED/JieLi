...
class BaseComputation(object):
      ...
      def compute_factor_in_peer(self, **kwargs):
          pass
      # endregion
class ComputeOPERATECASH(BaseComputation):
      computation_model_name = '经营活动现金流'
...
if __name__ == '__main__':
   compute_operatecash = ComputeOPERATECASH()
   rst = compute_operatecash.compute_factor('E00700', '20190423')
   print(rst)
   #data_peer = compute_operatecash.compute_factor_in_peer('E00005', '20190403')
   #print(data_peer)
