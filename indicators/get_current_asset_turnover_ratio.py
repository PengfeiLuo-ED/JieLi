# -*- coding: utf-8 -*-
"""
Created on Tue Apr 30 15:11:05 2019
...
class BaseComputation(object):
      ...
      def compute_factor_in_peer(self, **kwargs):
          pass
      # endregion
class ComputeCurrentAssetTurnoverRatio(BaseComputation):
      computation_model_name = '流动资产周转率'
      ...
      def compute_factor(self,stock_code, end_date):
          ...
          result1 = result1[['ReportType','Symbol','CurrentAssets','YearEnd']]
          result2 = result2[['ReportType','Symbol','LiquidFunds','YearEnd']]  
          result2.columns = ['ReportType','Symbol','CurrentAssets','YearEnd']
          result1 = pd.concat([result1,result2],axis = 0)          
          result1 = result1[result1['Symbol'] == stock_code][['ReportType','CurrentAssets','YearEnd']]
...
if __name__ == '__main__':
   compute_current_asset_turnover_ratio = ComputeCurrentAssetTurnoverRatio()
   rst = compute_current_asset_turnover_ratio.compute_factor('E00005', '20190423')
   print(rst)    
   
   data_peer = compute_current_asset_turnover_ratio.compute_factor_in_peer('E00005', '20190423')
   print(data_peer)
