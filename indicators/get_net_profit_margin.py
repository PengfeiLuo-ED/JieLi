# -*- coding: utf-8 -*-
"""
Created on Mon Apr 29 13:28:46 2019
...
class BaseComputation(object):
      ...
      def compute_factor_in_peer(self, **kwargs):
          pass
      # endregion
class ComputeNetProfitMargin(BaseComputation):
      computation_model_name = '销售净利率'
      ...
      def compute_factor(self,stock_code, end_date):
          ...
          result1 = result1[['ReportType','Symbol','NetProfitMargin','YearEnd']]
          result2 = result2[['ReportType','Symbol','Deposits_Equity','YearEnd']]
          result2.columns = ['ReportType','Symbol','NetProfitMargin','YearEnd'] 
          result1 = pd.concat([result1,result2],axis = 0)
          result1 = result1[result1['Symbol'] == stock_code][['ReportType','NetProfitMargin','YearEnd']]
...
if __name__ == '__main__':
   compute_net_profit_margin = ComputeNetProfitMargin()
   rst = compute_net_profit_margin.compute_factor('E00005', '20190423')
   print(rst)    
   
   data_peer = compute_net_profit_margin.compute_factor_in_peer('E02318', '20190423')
   print(data_peer)
