...
class BaseComputation(object):
      ...
      def compute_factor_in_peer(self, **kwargs):
          pass
      # endregion
class ComputeCASHFLOW_Ratio(BaseComputation):
      computation_model_name = '自由现金流与经营活动现金流比值'
      ...
      def compute_factor(self,stock_code, end_date):
          ...
          result2 = result2[['ReportType','Symbol','Currency','NCFOA','CEBY','NCFEY','ModifyTime']]
          result2 = result2[result2['Symbol'] == stock_code][['ReportType','Currency','NCFOA','CEBY','NCFEY','ModifyTime']]
          result2.loc[result2.ReportType == 2,['NCFOA','CEBY','NCFEY']] = result2.loc[result2.ReportType == 2,['NCFOA','CEBY','NCFEY']] *2
          result2.loc[result2.Currency == 'CNY',['NCFOA','CEBY','NCFEY']] = result2.loc[result2.Currency == 'CNY',['NCFOA','CEBY','NCFEY']] / 0.85        
          result2.loc[result2.Currency == 'JPY',['NCFOA','CEBY','NCFEY']] = result2.loc[result2.Currency == 'JPY',['NCFOA','CEBY','NCFEY']] / 5.99
          result2.loc[result2.Currency == 'MYR',['NCFOA','CEBY','NCFEY']] = result2.loc[result2.Currency == 'MYR',['NCFOA','CEBY','NCFEY']] * 1.62
          result2.loc[result2.Currency == 'SGD',['NCFOA','CEBY','NCFEY']] = result2.loc[result2.Currency == 'SGD',['NCFOA','CEBY','NCFEY']] * 4.95
          result2.loc[result2.Currency == 'USD',['NCFOA','CEBY','NCFEY']] = result2.loc[result2.Currency == 'USD',['NCFOA','CEBY','NCFEY']] * 7.6
...
if __name__ == '__main__':
   compute_cashflowratio = ComputeCASHFLOW_Ratio()
   rst = compute_cashflowratio.compute_factor('E00941', '20190423')
   print(rst)
   data_peer = compute_cashflowratio.compute_factor_in_peer('E00941', '20190423')
   print(data_peer)
